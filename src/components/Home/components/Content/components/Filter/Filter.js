...
import { Collapse, Flex, Menu, MenuList } from '@chakra-ui/react';

import { Button, InputBox, FilterGroup, MenuFilterItem } from './components';
    ...
    <Collapse in={isOpen} animateOpacity>
      ...
      >
        ...
        <FilterGroup title="Made With">
          <Menu>
            <Button>Made with</Button>
            <MenuList>
              <MenuFilterItem color="pink.500">All Apps</MenuFilterItem>
        ...
        <FilterGroup title="Downloads">
          <Menu>
            <Button>All Shots</Button>
            <MenuList>
              <MenuFilterItem color="pink.500">All Post</MenuFilterItem>
