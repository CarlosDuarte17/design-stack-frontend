...
export function ModalInfo() {
    ...
    return (
        <div>
        <Modal onClose={() => {Navigate(-1);setIsOpen(false)} } size="full" isOpen={isOpen} scrollBehavior="outside">
            <ModalOverlay />
                ...
                <Flex 
                    ...
                    <Box w="768px">
                        ...
                        <Flex 
                            ...
                            <PostButton label="Shot details" icon={FaInfoCircle} onOpenTag={onOpenTag} />
